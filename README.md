...
![48%](https://progress-bar.dev/47/?title=progresso)
...
UI tests testa se a interface do usuário do seu aplicativo funciona corretamente. A entrada do usuário deve acionar as ações corretas, os dados devem ser apresentados ao usuário, o estado da interface do usuário deve mudar conforme o esperado.

![](/assets/ui_tests.png)

UI Tests e end-to-end tests às vezes (como no caso de Mike Cohn) dizem ser a mesma coisa. Para mim, isso combina duas coisas que são conceitos bastante ortogonais.
